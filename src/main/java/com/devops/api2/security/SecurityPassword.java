...
public class SecurityPassword{
    public static void main(String[] args) {
        ...
        String secPassword = "SecucenIO!@#4";
        ...
        // 비밀번호 암호화 / 단방향 암호화
        String hashedPassword = passwordEncoder.encode(secPassword);

        System.out.println("Original password: " + secPassword);
        System.out.println("Hashed password: " + hashedPassword);

        // 비밀번호 확인
        boolean isMatch = passwordEncoder.matches(secPassword, hashedPassword);
